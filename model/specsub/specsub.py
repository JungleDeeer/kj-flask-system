...
import wave
# from model.utils.tools_utils import *
import math
import numpy as np
import ctypes as ct
...
def load_specsub(fileName):
    ...
    for n in range(0, Nframes):
        ...
        k = k + len2
    # 保存文件
    wf = wave.open('/home/aone/PycharmProjects/kj-flask-system/static/enhanced/' + "specsub" + fileName.split('/')[-1],
                   'wb')
    # 设置参数
    wf.setparams(params)
